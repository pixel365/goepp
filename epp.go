...
import (
	...
	"github.com/pixel365/goepp/command/delete"
	"github.com/pixel365/goepp/command/hello"
	"github.com/pixel365/goepp/command/info"
	"github.com/pixel365/goepp/command/login"
	"github.com/pixel365/goepp/command/logout"
	"github.com/pixel365/goepp/command/poll"
	"github.com/pixel365/goepp/command/renew"
	"github.com/pixel365/goepp/command/transfer"
...
func (e *EPP) Command() (command.Commander, error) {
	switch {
	case e.Hello != nil:
		return e.Hello, nil
	case e.Login != nil:
