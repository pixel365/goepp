...
type domainPeriodXML struct {
	Unit  command.PeriodUnit `xml:"unit,attr,omitempty"`
...
func (d *Domain) Validate() error {
	...
	if d.Period != nil {
		...
		if d.Period.Unit != "" && d.Period.Unit != command.PeriodUnitYear &&
			d.Period.Unit != command.PeriodUnitMonth {
